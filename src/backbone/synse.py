...
class SynseBackbone(BackboneAdapter):
    ...
    def from_checkpoint(cls, checkpoint_path: Path,
                        backbone_args: dict | None = None) -> "SynseBackbone":
    ...
    def _forward_from_skeletons(self, batch: torch.Tensor):
        raise NotImplementedError("SynseBackbone: provide a pre-encoded bundle.")


__all__ = ["SynseBackbone"]
